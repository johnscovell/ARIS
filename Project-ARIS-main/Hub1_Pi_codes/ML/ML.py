...
resting_data = pd.read_csv('/Users/bob_saget/Documents/UMass/2023 Fall/Senior Design/Project-ARIS-main/Hub1_Pi_codes/ML/Training_set/sensor_data_resting.csv')
walking_data = pd.read_csv('/Users/bob_saget/Documents/UMass/2023 Fall/Senior Design/Project-ARIS-main/Hub1_Pi_codes/ML/Training_set/sensor_data_walking.csv')
running_data = pd.read_csv('/Users/bob_saget/Documents/UMass/2023 Fall/Senior Design/Project-ARIS-main/Hub1_Pi_codes/ML/Training_set/sensor_data_running.csv')
...
while True:
    ...
    original_file_path = f"/Users/bob_saget/Documents/UMass/2023 Fall/Senior Design/Project-ARIS-main/Hub1_Pi_codes/Hub1_data/Hub1_sensor_data_{file_number}.csv"
    #/Users/bob_saget/Documents/UMass/2023 Fall/Senior Design/Project-ARIS-main/Hub1_Pi_codes/Hub1_data
        
    # Specify the new folder path
    new_folder_path = "/Users/bob_saget/Documents/UMass/2023 Fall/Senior Design/Project-ARIS-main/Hub1_Pi_codes/ML/ML_data"
    ...
    if predicted_label == 'resting':
        ...
        if np.any(heart_rate_reading >= thresholds['Heart_rate'][0]) and np.any(
            ...
            data.to_csv(f"/Users/bob_saget/Documents/UMass/2023 Fall/Senior Design/Project-ARIS-main/Hub1_Pi_codes/ML/ML_data_{file_number}.csv", index=False) 
            ...
            combined_data = combined_data.drop(['Sensor1a', 'Sensor1b', 'Sensor1c', 'Sensor1d', 'Sensor2a',  'Sensor2b', 
                                                'Sensor3a', 'Sensor3b', 'Sensor4a', 'Sensor4b',  'Sensor5a', 'Sensor5b', 'Sensor6a'], axis=1, errors = 'ignore') 
            # Drop rows with missing values
